...
def en_palabras(t)
	...
	case t.min
	when 0..10 
		puts "Son las #{t.hour} en punto "	
	when 11..20
		puts "Son las #{t.hour} y cuarto "	
	when 21..34
		puts "Son las #{t.hour} y media "
	when 35..44 
		puts "Son las #{t.hour + 1} menos veinticinco "	
	when 45..55 
		puts "Son las #{t.hour + 1} menos cuarto "	
	when 56..59 
		puts "casi son las #{t.hour + 1}"	
	end
end
